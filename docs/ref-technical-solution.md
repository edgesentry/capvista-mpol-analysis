...
Pre-designation lead time is measured on each data-publish run — see [indago dashboard](https://indago.edgesentry.io) or [indago-interpret-metrics](https://github.com/edgesentry/indago/blob/main/.agents/skills/indago-interpret-metrics/SKILL.md). Documented case studies: [C1 validation results](https://github.com/edgesentry/edgesentry-commercial/blob/main/docs/programs/202606-capvista-ai-joint-challenge/submission/c1-validation-results.md).
