 ...
 *
 * The manifest is generated when publishing score Parquets to R2 (indago:
 * `scripts/sync_r2.py push-arktrace` → `manifest.json` + legacy
 * `ducklake_manifest.json`). Production storage is plain Parquet under
 * `score/`, not a DuckLake catalog.
 */
